...
if(chapter.equals("chapter1")) allAmount=testBean.getKemu1Chapter1All();
if(chapter.equals("chapter2")) allAmount=testBean.getKemu1Chapter2All();
if(chapter.equals("chapter3")) allAmount=testBean.getKemu1Chapter3All();
if(chapter.equals("chapter4")) allAmount=testBean.getKemu1Chapter4All();
if(chapter.equals("chapter11")) allAmount=testBean.getKemu4Chapter1All();
if(chapter.equals("chapter12")) allAmount=testBean.getKemu4Chapter2All();
if(chapter.equals("chapter13")) allAmount=testBean.getKemu4Chapter3All();
if(chapter.equals("chapter14")) allAmount=testBean.getKemu4Chapter4All();
if(chapter.equals("chapter15")) allAmount=testBean.getKemu4Chapter5All();
if(chapter.equals("chapter16")) allAmount=testBean.getKemu4Chapter6All();
if(chapter.equals("chapter17")) allAmount=testBean.getKemu4Chapter7All();
String kemu = Integer.parseInt(chapter.substring(7))<10?"1":"4";
        	...
        	<div id="question">
            	...
            	<div class="itemQuestion">
                    <div class="itemQuestionWord">
                    		<%=originNumber%1000 %> / <%=allAmount%1000 %>
						...
						if(studentAnswer.length()>0){//已做完
							...
							try{
								...
								if(chapter.equals("chapter1")){
									sql.executeUpdate("UPDATE student SET kemu1Chapter1 = " + originNumber + " WHERE id = " + id);
									testBean.setKemu1Chapter1(originNumber);
								}
					            if(chapter.equals("chapter2")){
					            	sql.executeUpdate("UPDATE student SET kemu1Chapter2 = " + originNumber + " WHERE id = " + id);
					            	testBean.setKemu1Chapter2(originNumber);
					            }
					            if(chapter.equals("chapter3")){
					            	sql.executeUpdate("UPDATE student SET kemu1Chapter3 = " + originNumber + " WHERE id = " + id);
					            	testBean.setKemu1Chapter3(originNumber);
					            }
					            if(chapter.equals("chapter4")){
					            	sql.executeUpdate("UPDATE student SET kemu1Chapter4 = " + originNumber + " WHERE id = " + id);
					            	testBean.setKemu1Chapter4(originNumber);
					            }
					            if(chapter.equals("chapter11")){
									sql.executeUpdate("UPDATE student SET kemu4Chapter1 = " + originNumber + " WHERE id = " + id);
									testBean.setKemu4Chapter1(originNumber);
								}
					            if(chapter.equals("chapter12")){
					            	sql.executeUpdate("UPDATE student SET kemu4Chapter2 = " + originNumber + " WHERE id = " + id);
					            	testBean.setKemu4Chapter2(originNumber);
					            }
					            if(chapter.equals("chapter13")){
					            	sql.executeUpdate("UPDATE student SET kemu4Chapter3 = " + originNumber + " WHERE id = " + id);
					            	testBean.setKemu4Chapter3(originNumber);
					            }
					            if(chapter.equals("chapter14")){
					            	sql.executeUpdate("UPDATE student SET kemu4Chapter4 = " + originNumber + " WHERE id = " + id);
					            	testBean.setKemu4Chapter4(originNumber);
					            }
					            if(chapter.equals("chapter15")){
					            	sql.executeUpdate("UPDATE student SET kemu4Chapter5 = " + originNumber + " WHERE id = " + id);
					            	testBean.setKemu4Chapter5(originNumber);
					            }
					            if(chapter.equals("chapter16")){
					            	sql.executeUpdate("UPDATE student SET kemu4Chapter6 = " + originNumber + " WHERE id = " + id);
					            	testBean.setKemu4Chapter6(originNumber);
					            }
					            if(chapter.equals("chapter17")){
					            	sql.executeUpdate("UPDATE student SET kemu4Chapter7 = " + originNumber + " WHERE id = " + id);
					            	testBean.setKemu4Chapter7(originNumber);
					            }
							} catch(Exception e){	
							}              				
...
<%
                        } else if(originNumber%1000!=allAmount%1000){
%>
							<form id="next" action="chapterPractiseServlet" method=post name="formNext">
...
<%
                        	...
                        	testBean.setFinishChapter("本章节已练习完毕，是否退出？");
%>
							<jsp:setProperty name="testBean" value="本章节已练习完毕，是否退出？" property="finishChapter" />
...
%>                
                        ...
                        <div class="others">
                        	<div class="align"></div>
                        	<%if(kemu.equals("1")){ %>                            
                            	<div class="other"><a id="quit" href="Kemu1.jsp"><img src="images/student/quitButton.png" /></a></div>
                            <%} else{ %>
                            	<div class="other"><a id="quit" href="Kemu4.jsp"><img src="images/student/quitButton.png" /></a></div>
                            <%} %>
                        </div>
                        <div class="cleaner"></div>
                        <div id="autoSubmit">
                        	<form id="autoSubmit" action="autoSubmitServlet" method=post name="autoSubmit">
                        		<input type="hidden" name="whereToGo" value="chapter" />
                        		<input type="hidden" id="hiddenTimeCounterMin2" name="timeCounterMin">
		                    	<input type="hidden" id="hiddenTimeCounterSec2" name="timeCounterSec">
                    			<input type="hidden" value="<%=testBean.getId()%>" name ="id">
<%								
...
<script language="javascript">
	...
	function Notify(){
		if(a.length!=0&&a!="null"){
			if(confirm(a)){
				var href=document.getElementById("quit").href;
...
<%
	...
	System.out.println("ChapterPractise.jsp  "+e);

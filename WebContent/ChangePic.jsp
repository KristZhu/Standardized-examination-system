...
String number = testBean.getChangePicNumber();
        	...
        	<div class="changeQuestion">
                ...
                <div class="itemChangeQuestion">
                	<div class="itemChangeQuestionContent">
                		<form method="post" action="uploadChangeServlet" enctype="multipart/form-data" onsubmit="return Submit();">
						    ...
						    <br />选择图片
						    <input style="font-size:20px;" type="file" name="uploadFile" />
						    <br/><br/>
...
function Submit(){
	return confirm("修改后不可撤销，是否确认？");	
                		...
                		<div class="others">
        					<!--<div class="align"></div>-->                            
       						<div class="other"><a href="CheckKemu1.jsp"><img src="images/student/quitButton.png" /></a></div>
    					</div>
    					<div class="cleaner"></div>	
                    </div>
                </div>
...
<%
	...
	System.out.println("ChangePic.jsp  "+e);

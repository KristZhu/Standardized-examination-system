    ...
    <div id="middle">
		...
		<div class="navi">
       		<ul>
                ...
                <li><a href="AddKemu4Judge.jsp">科目四</a></li>
        	</ul>
    	</div>
        	...
        	<div class="addQuestion">
                ...
                <div class="itemAddQuestion">
                	<div class="itemAddQuestionContent">
                		<div id="changeType">
	                		<a href="AddKemu1MultipleChoice.jsp"><input class="unselectedType" type="submit" name="" value=""/></a><div id="changeTypeWord">单选</div>
	                		<a href=""><input class="selectedType" type="submit" name="" value=""/></a><div id="changeTypeWord">判断</div>
	                		<a href=""><input class="unselectedType" type="submit" name="" value="" disabled="disabled"/></a><div id="changeTypeWord" style="color:gray;">多选</div>
	                	</div>
...
<%
	...
	System.out.println("AddKemu1Judge.jsp  "+e);

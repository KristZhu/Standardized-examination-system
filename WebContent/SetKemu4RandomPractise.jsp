...
<div id="content">
	<div id="left">
        ...
        <div class="class_1" class="selected">
		...
		<div class="navi">
       		<ul>
                <li><a href="SetKemu1RandomPractise.jsp">科目一</a></li>
...
<script type="text/javascript">
  ...
  <%
  	...
  	if(valid){
  		testBean.setRandomPractiseKemu("4");
%> 
...
<%
	...
	System.out.println("SetKemu4RandomPractise.jsp  "+e);

    ...
    <div id="middle">
		...
		<div class="navi">
       		<ul>
                ...
                <li><a href="AddKemu4MultipleChoice.jsp">科目四</a></li>
        	</ul>
    	</div>
        	...
        	<div class="addQuestion">
                ...
                <div class="itemAddQuestion">
                	<div class="itemAddQuestionContent">
                		<div id="changeType">
	                		<a href=""><input class="selectedType" type="submit" name="" value=""/></a><div id="changeTypeWord">单选</div>
	                		<a href="AddKemu1Judge.jsp"><input class="unselectedType" type="submit" name="" value=""/></a><div id="changeTypeWord">判断</div>
	                		<input class="unselectedType" type="submit" name="" value="" disabled="disabled"/><div id="changeTypeWord" style="color:gray;">多选</div>
	                	</div>
...
%>
                						<input type="radio" name="chapter" value=chapter1 />第1章 道路交通安全法律、法规和规章<br />
                						...
                						<input type="radio" name="chapter" value=chapter4 checked />第4章 机动车驾驶操作相关基础知识<br />
<%
	} else if(chapter.equals("chapter2")){
%>
                						<input type="radio" name="chapter" value=chapter1 />第1章 道路交通安全法律、法规和规章<br />
                						<input type="radio" name="chapter" value=chapter2 checked />第2章 交通信号<br />
                						<input type="radio" name="chapter" value=chapter3 />第3章 安全行车、文明驾驶基础知识<br />
...
%>
                						<input type="radio" name="chapter" value=chapter1 />第1章 道路交通安全法律、法规和规章<br />
                						<input type="radio" name="chapter" value=chapter2 />第2章 交通信号<br />
                						<input type="radio" name="chapter" value=chapter3 checked />第3章 安全行车、文明驾驶基础知识<br />
                						<input type="radio" name="chapter" value=chapter4 />第4章 机动车驾驶操作相关基础知识<br />
<%
	} else{
%>
...
<%
	...
	System.out.println("AddKemu1MultipleChoice.jsp  "+e);

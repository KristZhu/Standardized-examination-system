...
<div id="content">
    ...
    <div id="middle">
		...
		<div class="navi">
       		<ul>
                <li><a href="AddKemu1MultipleChoice.jsp">科目一</a></li>
                ...
                <div class="itemAddQuestion">
                	<div class="itemAddQuestionContent">
                		<div id="changeType">
	                		...
	                		<a href="AddKemu4Judge.jsp"><input class="unselectedType" type="submit" name="" value="" /></a><div id="changeTypeWord">判断</div>
...
<%
	...
	System.out.println("AddKemu4MultipleChoice.jsp  "+e);
